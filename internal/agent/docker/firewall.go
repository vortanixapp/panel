...
// containerIP — адрес контейнера в сети docker.
//
// Разделитель в шаблоне обязателен: контейнер может состоять в нескольких
// сетях, и без пробела адреса склеивались в одну строку вида
// «172.17.0.2172.18.0.3». Такое значение уходило в правило iptables как адрес
// источника. Берём первый непустой.
//
// Пустой ответ означает сеть host, сеть none или остановленный контейнер.
