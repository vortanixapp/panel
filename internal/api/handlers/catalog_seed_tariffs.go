...
func upsertTariffs(ctx context.Context, db catalogDB, gameID string, g gamecatalog.Game) error {
	for _, spec := range buildTariffSpecs(g) {
		...
		if _, err := db.Exec(ctx, `
			INSERT INTO core.tariffs (
				game_id, name, slug, billing_type, price_monthly, currency,
				slots_min, slots_max, cpu_cores, ram_mb, disk_mb, position, active, meta
			)
			VALUES ($1, $2, $3, 'resources', $4, 'RUB', $5, $6, $7, $8, $9, $10, true, $11::jsonb)
