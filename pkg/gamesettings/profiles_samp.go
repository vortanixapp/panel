...
// Профили многопользовательских модов GTA: SA-MP, CRMP и MTA:SA.
//
// У SA-MP и CRMP конфиг общий по формату — server.cfg вида «ключ значение».
// MTA устроен иначе: XML-файл mtaserver.conf с тегами.
