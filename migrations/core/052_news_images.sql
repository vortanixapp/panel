-- Картинки новостей.
--
-- В новой панели их не было ни в каком виде: newsImageFromMeta читала
-- meta->>'image_url', но ни один обработчик в meta ничего не писал — код был
-- мёртвый, а обложка у новости всегда пустая.
--
-- Отдельная таблица, а не колонка: в старой панели к новости прикреплялось
-- несколько изображений с заданным порядком.
