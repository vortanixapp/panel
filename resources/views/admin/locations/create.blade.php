...
@section('page_title', 'Новая локация')

@section('content')
    <section class="px-4 py-6 md:py-8">
        <div class="w-full max-w-none space-y-6">
            <div>
                <h1 class="text-xl md:text-2xl font-semibold tracking-tight text-slate-100">Новая локация</h1>
                <p class="mt-1 text-sm text-slate-300/80">Добавьте дату‑центр или регион, который будет доступен при размещении игровых серверов.</p>
            </div>
                ...
                <form method="POST" action="{{ route('admin.locations.store') }}" class="space-y-4">
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div class="space-y-1">
                            ...
                            >
                            <p class="mt-1 text-[11px] text-slate-300/70">Латинский код, например <code>eu-frankfurt</code>.</p>
                        </div>
