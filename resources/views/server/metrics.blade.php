...
@section('content')
    <section class="py-6">
        <div class="w-full px-4 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden rounded-3xl bg-white/90 text-slate-900 shadow-sm transition-shadow duration-300 hover:shadow-md">
                <div class="bg-slate-50/70">
                    @include('server.partials.tabs')
                </div>
            </div>

            @include('server.partials.metrics')
        </div>
    </section>

    @include('server.partials.scripts-metrics')
@endsection
