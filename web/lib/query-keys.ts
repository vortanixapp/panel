export const queryKeys = {
  ...
  adminServerAudit: (id: string) => ["admin-servers", id, "audit"] as const,
  ...
  agentContainers: (id: string) => ["agents", id, "containers"] as const,
  agentDisk: (id: string) => ["agents", id, "disk"] as const,
  agentDiagnostics: (id: string) => ["agents", id, "diagnostics"] as const,
  agentTask: (id: string, taskId: string) => ["agents", id, "task", taskId] as const,
