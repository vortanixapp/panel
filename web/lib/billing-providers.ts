...
export const BILLING_PROVIDERS: BillingProviderDef[] = [
  ...
  { key: "tkassa", name: "Т-Касса", descKey: "billing.provider.desc.cards_ru" },
  { key: "robokassa", name: "Robokassa", descKey: "billing.provider.desc.cards_wallets" },
  { key: "freekassa", name: "FreeKassa", descKey: "billing.provider.desc.cards_wallets" },
  ...
  { key: "enot", name: "Enot.io", descKey: "billing.provider.desc.cards_wallets" },
  ...
  { key: "webpay", name: "WebPay.by", descKey: "billing.provider.desc.cards_payments" },
  { key: "advcash", name: "AdvCash (Volet)", descKey: "billing.provider.desc.wallets_cards" },
  ...
  { key: "coinbase", name: "Coinbase Commerce", descKey: "billing.provider.desc.crypto" },
  { key: "cryptocom", name: "Crypto.com Pay", descKey: "billing.provider.desc.crypto" },
