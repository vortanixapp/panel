...
// Цвет бренда раньше уезжал в переменную --brand-primary, которую не читал ни
// один стиль: администратор менял цвет, и не менялось ничего. Теперь он задаёт
// те же токены, на которых построены кнопки, ссылки и выделение в меню.
...
// Подпись на кнопке должна остаться читаемой на любом выбранном цвете, поэтому
// берём чёрный или белый по яркости фона, а не фиксированный светлый текст.
