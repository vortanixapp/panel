...
// Список читается на уровне модуля, поэтому храним ключи: готовые подписи
  ...
  const spin = useMutation({
    ...
    onSuccess: (res) => {
      ...
      settleTimer.current = setTimeout(() => {
        ...
        // Бонус создаёт уведомление, поэтому бейдж колокольчика тоже устарел.
        // Без этой строки он обновлялся только следующим опросом, через минуту.
