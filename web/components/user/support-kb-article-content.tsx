...
export function SupportKBArticleContent() {
  ...
  // Соседние статьи того же раздела: дочитав одну, чаще всего нужна следующая.
      ...
      <div className="flex w-full flex-col gap-[22px]">
        ...
        <div className="grid grid-cols-1 items-start gap-5 lg:grid-cols-[minmax(0,1fr)_300px]">
          <article className="rounded-2xl border border-border bg-card px-[22px] py-5">
            ...
            {/* Текст статьи выводим как есть, с сохранением переводов строк.
                Разметку не разбираем намеренно: статьи пишет администратор
                панели, и трактовать их содержимое как HTML значило бы дать ему
                исполнять скрипты в чужих браузерах. */}
