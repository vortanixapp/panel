...
export function KBAdminPageContent() {
  ...
  const refresh = () => {
    ...
    // Клиентские списки читают отдельный ключ: без сброса статья появилась бы
    // в админке, но не у клиента до перезагрузки страницы.
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-[14px] sm:grid-cols-2">
              ...
              <label className="flex flex-col gap-[7px]">
                ...
                />
                {/* Из русского заголовка адрес не выводится — транслитерации
                    в проекте нет, и сервер вернёт ошибку вместо статьи по
                    адресу вида «---». Говорим об этом заранее. */}
