...
// Шесть видов действий — ровно те, что понимает агент. Подписи человеческие:
// в старой панели в списке стояли машинные имена, и понять, чем append_lines
// отличается от ensure_contains, можно было только опытным путём.
// Тексты храним ключами: список читается на уровне модуля, и готовый текст
