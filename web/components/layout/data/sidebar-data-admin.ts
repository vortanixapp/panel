...
export function adminSidebarNavGroups(): NavGroup[] {
  return [
  {
  ...
  },
  {
    ...
    items: [
      ...
      // Личные настройки — профиль, аккаунт, внешний вид, уведомления — живут
      // в кабинете и открываются из меню пользователя. В админском меню они
      // дублировали кабинет и уводили из раздела администратора.
    ],
  },
  ];
}
