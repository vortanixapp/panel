...
// Директива нужна из-за useT(): снимок используется и из серверной обёртки
// SplitAuthLayout, где хук без неё не запустился бы.
          ...
          <div className="grid gap-3 lg:grid-cols-5">
            ...
            <div className="rounded-xl border border-border/60 bg-card/80 p-3 lg:col-span-3">
              <div className="mb-2 flex items-center gap-2 text-[10px] text-muted-foreground">
                ...
                <span className="ms-auto rounded-full bg-emerald-500/15 px-1.5 py-0.5 text-[9px] text-emerald-400">
                  running
                </span>
              </div>
              <div className="space-y-1 rounded-lg bg-black/50 p-3 font-mono text-[10px] leading-relaxed">
