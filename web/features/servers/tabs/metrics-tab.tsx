...
// Потолок оси считаем по данным, а не берём 100%: игровой сервер живёт на
// единицах процентов, и на шкале до ста обе линии сливались в прямую у самого
// дна. Шкала подписана цифрами, иначе автомасштаб врёт о нагрузке.
